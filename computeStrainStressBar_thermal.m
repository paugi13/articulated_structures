function [eps,sig] = computeStrainStressBar(n_d,n_el,u,Td,x,Tn,mat,Tmat,R_e,E_e,l_e)
%--------------------------------------------------------------------------
...
%The elements share nodes, so its displacement its applied equally to both
%elements.
%With Td we select the degree of freedom whose displacement must be applied
...
u_e_local = zeros(size(Td,2), 1, n_el);
